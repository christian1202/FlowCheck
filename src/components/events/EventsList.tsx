      ...
      <div className="claude-card rounded-3xl hover-lift p-6 flex flex-col h-full min-h-[280px] transition-colors duration-150 transform-gpu relative overflow-hidden">
        ...
        <div className="space-y-2 mb-6 relative z-10 text-xs text-slate-300">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-white/[0.04] border border-slate-800 md:border-white/10 flex items-center justify-center text-slate-400">
          ...
          >
            {virtualItems.map((virtualRow) => {
              ...
              return (
                ...
                >
                  <div style={{ contain: 'content' }} className="h-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-6 items-stretch px-1">
                  {isLoader ? (
