...
function SystemInfoModal({ isCollapsed, className, iconOnly }: SystemInfoModalProps) {
  ...
  const defaultClassName = "flex items-center gap-3.5 w-full px-3.5 py-2.5 rounded-xl text-xs font-medium text-slate-400 hover:bg-white/[0.04] hover:text-slate-200 transition-colors transition-transform transform-gpu active-scale";
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <a
                  ...
                  className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3 py-1.5 bg-slate-950/80 text-white border border-white/10 rounded-xl hover:border-amber-500/30 transition-colors transition-transform transform-gpu text-xs font-mono active-scale"
                >
